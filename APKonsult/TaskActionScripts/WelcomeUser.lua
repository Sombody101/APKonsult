...
function eventFired()
    goodbyeMessage = "Hey there, " .. eventArgs.Member.Mention .. "! Welcome to the Bot Tester server! 👋\n\n" ..
        "We've got two APKonsult bot instances for you to try:\n* **Testing Ground:** " ..
        debugChannelMention .. " - This bot has the latest features but might be a little buggy, but is only active when the developer is debugging a feature.\n* **Stable Bot:** " ..
        releaseChannelMention .. " - This bot is more stable but might have fewer features and not as up-to-date.\n" ..
...
log("MemberAdded message active.")
keepAlive()
